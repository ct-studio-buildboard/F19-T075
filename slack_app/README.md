...
* [send data to google sheets from slack](https://davidwalsh.name/using-slack-slash-commands-to-send-data-from-slack-into-google-sheets)  
* [an overview of modals](https://api.slack.com/surfaces/modals)  